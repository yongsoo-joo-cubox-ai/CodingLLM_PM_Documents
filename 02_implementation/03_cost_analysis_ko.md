...
> **구현 문서 3/5** | 이전: [투입 인력](./02_resource_plan_ko.md) | 다음: [기술 스택](./04_phase2_tech_stack_ko.md) | [폴더 인덱스](./README.md)

---

> **TL;DR**
> - 온프레미스 3년 TCO **7,100만~14,200만원** vs 클라우드 **7,500만~15,000만원** → 상시 운영 시 온프레미스 유리
> - GPU 서버(RTX 4090×2 기준) 초기 비용 3,500만~7,000만원, 연간 운영 1,200만~2,400만원
> - PoC/간헐적 사용은 클라우드 권장, 상시 운영은 온프레미스 권장
>
> **대상**: 경영진 | **소요**: ~10분 | **용어**: [용어집](../05_knowledge_base/glossary_ko.md)
...
**(v2.0 추가)** 부산은행 PoC 진행 시, 은행 측 폐쇄망에 배포할 최소 구성(PoC용) 비용이 핵심 고려사항. GPU 서버 1대 + Docker 기반 Playground 구성 필요.
...
| 2.0 | 2026-03-19 | 부산은행 PoC 비용 고려사항 추가 | 분석팀 |
| 2.1 | 2026-03-19 | TL;DR 블록 추가, 파일명 넘버링 적용 | PM (주용수) |
