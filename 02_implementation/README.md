...
| [09_vllm_infra_roadmap_ko.md](./09_vllm_infra_roadmap_ko.md) | vLLM 인프라 고도화 로드맵 — Infra-S0~S3 실행 계획 + secern-vllm-ext 레포 | 로드맵 (v1.0) |
...
- vLLM 인프라 PRD(08)가 요구사항 → 09_vllm_infra_roadmap이 실행 계획 → secern-vllm-ext/가 구현 코드
