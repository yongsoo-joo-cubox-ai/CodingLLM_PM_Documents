...
| 단계 | 기간 | 내용 | 핵심 기술 | 상태 |
|------|------|------|----------|------|
| **Infra-S0** | 2026-04~05 | 모델 가중치 암호화 (Tensorizer + libsodium) | Tensorizer, libsodium, Go keygen | 계획 |
...
| vLLM Infra-S0 | (신규) | **2026.04~05** | 모델 가중치 암호화 (Tensorizer + libsodium + Go keygen) | 📋 계획 |
