...
|------|------|------|--------------------|---------|------|
| **Infra-S0** | 2026-04~06 | 모델 가중치 암호화 + 라이선스 키 관리 | python/secernai_crypto + cmd/keygen + cmd/license-agent | PRD §4.1 (P0) | **Phase 5 완료, Phase 6 계획 수립** — Phase 1~5 전 PASS. Phase 6 License Agent + KeyProvider + 3계층 라이선스 보호 계획 수립 (2026-04-06) |
...
| Phase 6 | W7-12 | License Agent + KeyProvider + 3계층 라이선스 보호 | License Agent 바이너리, key_provider.py | cmd/license-agent/, python/secernai_crypto/key_provider.py | MLX 트랙 LicenseSDK 통합 결정 (2026-04-10) |
