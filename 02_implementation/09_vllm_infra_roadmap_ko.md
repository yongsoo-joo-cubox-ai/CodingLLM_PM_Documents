...
| Phase B | 2026-04~ | 번들 패키징 (macOS arm64, 문기봉 상무 전달 / 내부 테스트) | tar.gz + install.sh(uv 기본 + portable Python fallback), 4bit/8bit/bf16 분할/통합, Google Drive 배포, 폐쇄망 운영 OK(performOfflineAuth 폴백), LIC-06 번들 전용 키 `4G6E-W8YL-XZG7-EJNB` -ldflags 주입 | scripts/build_bundle.sh (추후 추가) | 📋 계획 수립 중 |
