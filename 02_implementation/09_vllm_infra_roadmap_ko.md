...
|------|------|------|--------------------|---------|------|
| **Infra-S0** | 2026-04~06 | 모델 가중치 암호화 + 라이선스 키 관리 | python/secernai_crypto + cmd/keygen + cmd/license-agent | PRD §4.1 (P0) | **Phase 5 Track 3 실측 완료, Phase 6 진행 중** — Phase 1~5 전 PASS. Phase 5 Track 3 License Agent LicenseSDK 통합 Step 0~6 실측 완료 (2026-04-10, 12/12 시나리오 처리, R-BUG-1/2/3 수정). Phase 6 License Agent + KeyProvider + 3계층 라이선스 보호 진행 중 |
...
| Phase 6 | W7-12 | License Agent + KeyProvider + 3계층 라이선스 보호 | License Agent 바이너리, key_provider.py | cmd/license-agent/, python/secernai_crypto/key_provider.py | 진행 중 (Phase 5 Track 3 실측 기반) |
