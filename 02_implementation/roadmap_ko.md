...
**Coder와의 관계**: xFrame5는 Coder의 **첫 번째 응용 사례**. 프레임워크 분리(Phase 1) 후 Spring, Vue, React 등으로 확장 예정.
...
> **중요**: vLLM 0.6 미만 버전에서는 tool calling이 지원되지 않아 Coder의 6단계 파이프라인이 정상 동작하지 않습니다.
...
**Coder 구현 로드맵 v2.0** | 분석팀 | 2026-01-21
