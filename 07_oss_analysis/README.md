...
- [트랙 2 기술 전략 리서치](../01_strategy/05_track2_tech_strategy_ko.md) — SecernCode(Go) 기반 코딩 에이전트 전략
- [Go vs TypeScript ADR](../01_strategy/06_go_vs_ts_adr_ko.md) — Track 2 기술 선택 의사결정 기록
